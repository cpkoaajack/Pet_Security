...
//SENSOR3
#define US_SENSOR3_PORT							GPIOC
#define US_SENSOR3_ECHO_PIN					GPIO_Pin_6	//TIM4 CH1 (echo input)
#define US_SENSOR3_TRIG_PIN					GPIO_Pin_8	//TIM4 CH3 (trig output)
...
static void initMeasureTimer_SENSOR3(void);
...
int32_t HCSR04GetDistanceS3(void);
